...
# Answer
# Yes there is a difference between the two.  The first method is a pass by 
# reference method as we mutating the object (buffer) being passed in as an 
# argument. The second method is using assignment =, this is a none mutating 
# method, a pass by value, the input arguments will not be altered after 
# rolling_buffer2 has run. 